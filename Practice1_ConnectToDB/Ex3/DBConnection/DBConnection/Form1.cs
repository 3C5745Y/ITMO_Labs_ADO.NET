...
namespace DBConnection
{
    public partial class Form1 : Form
    {
        ...
        //преднамеренная ошибка в имени сервера
        string testConnect = @"Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;Initial Catalog=AdventureWorks2019;Data Source=B232\SQLEXPRSS";
