...
namespace DBConnection
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            command.CommandText = "SELECT Name FROM Production.ProductModel";
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                command.CommandText = "INSERT INTO Production.ProductModel (Name) VALUES('Wrong size')";
                command.ExecuteNonQuery();
                command.CommandText = "INSERT INTO Production.ProductModel (Name) VALUES('Wrong color')";
                command.ExecuteNonQuery();
