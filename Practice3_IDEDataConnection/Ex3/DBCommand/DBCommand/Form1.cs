...
namespace DBCommand
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand2.CommandText = "uspGetEmployeeManagers";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            sqlCommand4.Parameters["@SalesPersonID"].Value = SalesPersonIDTextBox.Text;
            sqlConnection1.Open();
        ...
        {
            System.Text.StringBuilder results = new System.Text.StringBuilder();
            sqlCommand5.Parameters["@BusinessEntityID"].Value = BusinessEntityIDTextBox.Text;
